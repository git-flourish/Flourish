  ...
  return (
    <>
      <section className="relative min-h-screen bg-cream flex flex-col items-center justify-center overflow-hidden">
        ...
        {/* Background giant outlined wordmark */}
        <div
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          <p
            className="font-sans text-base md:text-lg text-mulberry/70 max-w-xl mx-auto leading-relaxed mb-10 fade-up"
            style={{ animationDelay: "0.45s" }}
          >
            Four phases. Four formulas. Finally, supplements that actually match
            what your body needs — phase by phase.
          </p>
          ...
          {/* Social proof mini */}
          <div
            className="mt-12 flex items-center justify-center gap-2 fade-up"
